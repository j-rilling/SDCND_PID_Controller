...
with open('log_twiddle_4.csv') as csvFile:
...
figure1.savefig('ImgsReport/twiddle_4_SP_PV_CV.png')
...
figure2.savefig('ImgsReport/twiddle_4_Param.png')

figure3, fig3_axes = plt.subplots(1,1)
fig3_axes.plot(time_s, best_error)
figure3.savefig('ImgsReport/twiddle_4_Error.png')
