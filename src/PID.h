...
class PID {
 public:
   ...
   */
  void InitCoeffs(double Kp_, double Ki_, double Kd_, double p_change_, double i_change_, double d_change_);
   ...
   */
  void setLimits(double SP_min_, double SP_max_, double CV_min_, double CV_max_, double pert_min_, double pert_max_);
   ...
   */
  double updateController(double currentPV, double pert);
   ...
   */
  void twiddleOpt(double currentPV, double tolerance);
  ...
  /**
   * Scales one variable from one frame to another
   */
  double scale(double in, double in_min, double in_max, double out_min, double out_max);
